...
static class NGUIPrefabStageHelper
{
    ...
    // This is a patch for PrefabStageUtility.cs functions: https://github.com/Unity-Technologies/UnityCsReference/
    // blob/31c7ca85bcc43ef4258c2a216b195ad1d6e59948/Editor/Mono/SceneManagement/StageManager/PrefabStage/PrefabStageUtility.cs
    // which are called in the PrefabStage.cs file for initializing a stage https://github.com/Unity-Technologies/UnityCsReference/
    // blob/2d9e6431c06e628577d972e063ba0998cfa338cb/Editor/Mono/SceneManagement/StageManager/PrefabStage/PrefabStage.cs

    [HarmonyPatch (typeof (PrefabStageUtility))]
    [HarmonyPatch ("MovePrefabRootToEnvironmentScene")]
    public class PatchSceneRoot
    {
        static void Postfix (Scene __result, GameObject prefabInstanceRoot) 
        {
            // Handling inconvenient var names
            var instanceRoot = prefabInstanceRoot;
            var scene = __result;
